    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (res.success && token) {
                setToken(token);
                Cookies.set('rr_token', token, { expires: 1 });
                ...
                <div className={`w-full max-w-sm ${isShaking ? 'animate-[shake_0.5s_ease-in-out]' : ''}`}>
                    <header className="mb-8 text-center lg:text-left">
                        <div className="inline-flex items-center gap-1.5 px-2.5 py-0.5 bg-white dark:bg-slate-900 shadow-sm border border-slate-100 dark:border-slate-800 rounded-full mb-4">
                            ...
                            <span className="text-[9px] font-black text-slate-500 uppercase tracking-[0.2em]">Authorized Personnel</span>
                        </div>
                    ...
                    <form onSubmit={handleLogin} className="space-y-4">
                        ...
                        <div className="space-y-1">
                            <label className="text-[9px] font-black text-slate-400 uppercase tracking-widest ml-1" htmlFor="password">Password</label>
                            <div className="relative group">
                                <input 
                        ...
                        <div className="flex items-center justify-between pt-1">
                            <label className="flex items-center gap-2 cursor-pointer group">
                                ...
                                <span className="text-[10px] font-bold text-slate-400 group-hover:text-slate-600 transition-colors">Remember Me</span>
                            </label>
