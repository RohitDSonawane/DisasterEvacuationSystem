...
public:
    ...
    void runInteractive();
    void runJSONServer(); // New: JSON protocol for web communication
    
    // Serialization helpers
    std::string evacuationResultToJSON(const EvacuationResult& result);
    std::string treeToJSON(TreeNode* node);
    std::string shelterSummaryToJSON();
